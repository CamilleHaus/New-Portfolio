...
const ProjectCard: React.FC<IProjectCard> = ({ project }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-primary bg-opacity-80 shadow-lg w-[600px] max-h-[600px] p-1 flex flex-col max-sm:w-[90%] max-sm:h-[fit]">
        <div className="border-2 border-primary h-[100%] p-8 bg-projects bg-cover flex flex-col justify-between gap-6">
